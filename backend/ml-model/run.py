...
parser.add_argument('--im_path', type=str, default='./1.jpg',
...
def main(args):
	...
	with tf.compat.v1.Session() as sess:
		...
		saver = tf.compat.v1.train.import_meta_graph('./pretrained_r3d.meta')
		saver.restore(sess, './pretrained_r3d')
		...
		imsave('./floorplan.png', floorplan_rgb)
		#plt.show()
