    ...
    <div className="mt-8">
      <div className="flex justify-between items-center mb-4">
        <button
          ...
          className="px-4 py-2 rounded-md bg-black text-white hover:bg-gray-700 transition-colors duration-300"
        >
          Previous
        </button>
          ...
          <div key={index} className="mb-4 bg-white rounded-lg shadow-md">
            <div className="flex items-center justify-between p-4">
              <div className="flex-1">
                <h3 className="text-xl font-semibold text-gray-800 mr-4">{event.title}</h3>
              </div>
              <div className="flex-1">
                <p className="text-gray-500 mr-4">{event.time} - {event.location}</p>
              </div>
              <div className="flex-1">
